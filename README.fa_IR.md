...
<p align="center">
  <code>bash &lt;(curl -Ls https://raw.githubusercontent.com/ksgamer31/3x-ui/main/install.sh) v1.0.4-ksmrx</code>
</p>
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/ksgamer31/3x-ui/main/install.sh) v1.0.4-ksmrx
```

وقتی `v1.0.4-ksmrx` به عنوان latest ثبت شد، بدون ورژن هم کار می‌کند:
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/ksgamer31/3x-ui/main/install.sh) v1.0.4-ksmrx
